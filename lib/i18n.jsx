  ...
  en: {
    ...
    flavors: {
      ...
      items: {
        ...
        chocolate: { title: 'Chocolate Hazelnut', sub: '+ Hazelnut Cream' },
        orange: { title: 'Orange Cardamom', sub: '+ Cardamom Glaze' },
        strawberry: { title: 'Strawberries & Cream', sub: '+ Vanilla Cream' },
        strawberries: { title: 'Strawberries & Cream', sub: '+ Vanilla Cream' },
      },
    },
    flavours: {
      heading: 'THE FLAVORS',
  ...
  ar: {
    ...
    flavors: {
      ...
      items: {
        ...
        chocolate: { title: 'شوكولاتة وبندق', sub: '+ كريمة بندق' },
        orange: { title: 'برتقال وهيل', sub: '+ غليز هيل' },
        strawberry: { title: 'فراولة وكريمة', sub: '+ كريمة فانيلا' },
        strawberries: { title: 'فراولة وكريمة', sub: '+ كريمة فانيلا' },
      },
    },
    flavours: {
      heading: 'النكهات',
