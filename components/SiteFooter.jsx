  ...
  return (
    <footer id="site-footer" className="w-full">
      ...
      <div className="flex w-full flex-col items-center justify-center bg-[url('/donutfinal/footer.jpeg')] bg-cover bg-center bg-no-repeat px-5 py-16 text-center">
        <p
          className="font-['Clarendon'] text-[clamp(34px,7vw,82px)] font-black italic leading-none text-white max-md:font-['Clarendon']"
        ...
        <a
          ...
          className="mt-5 font-['Lora'] text-xl font-bold text-white md:text-2xl max-md:font-['Lora']"
          style={{ color: '#fff' }}
        >
          {t('footer.instagram')}
        </a>
