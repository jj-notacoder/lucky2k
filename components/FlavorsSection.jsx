    ...
    <section id="flavors" className="relative z-20 w-full candy-stripes pt-24 md:pt-32">
      ...
      <div className="relative overflow-x-clip bg-transparent pb-24 md:pb-32">
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-5 pt-16 md:pt-20">
          ...
          >
            <h2 className="font-['Impact'] font-black italic uppercase text-white text-[clamp(3rem,14vw,3.75rem)] md:text-8xl drop-shadow-[0_0_15px_#EF2E31,0_0_30px_#EF2E31] tracking-wide leading-none max-md:font-['Impact']">
              {t('flavors.heading')}
            </h2>
